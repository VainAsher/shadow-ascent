...
## Extended Studio-Pack Branches
- `./09_level_and_content_plan/` - campaign content taxonomy, dungeon planning, optional content, and procedural room intents
- `./10_systems_architecture_pack/` - runtime structure, procgen, validation, entity model, and co-op rules
- `./11_production_scope_and_roadmap/` - scope control, vertical slice, milestones, and MVP framing
- `./12_qa_telemetry_and_acceptance_criteria/` - QA priorities, telemetry targets, and acceptance gates
- `./13_risks_open_questions_and_studio_recommendations/` - strategic risks, unresolved questions, and studio guidance
- `./14_appendices/` - reusable checklists, templates, example specs, and alignment notes
