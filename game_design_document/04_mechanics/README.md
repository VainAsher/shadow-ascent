...
## Purpose
Documents the rules and systems that govern interaction with the game.

## Indie Game Academy Summary
This domain groups the GDD topics that belong to **Mechanics** so contributors know where to place high-level design information.
